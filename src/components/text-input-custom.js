...
const TextInputCus = (
  ...
  }; // này là để check xem có focus vào input không, nếu có thì hiện label, không thì ẩn label
  ...
  return (
    <View style={[styles.root]}>
      <View
        ...
        <TextInput // quan trọng nhất là cái này, nó sẽ nhận giá trị từ props và truyền vào
          style={styles.input}
          ref={input => props.inputRef && props.inputRef(input)} // định dạng ref. vì tách ra nên khá phức tạp, ref từng thằng khi mà mình gọi
          ...
          {...props} // không cover het props nện phải dùng {...props} để truyền hết props vào
          placeholder={label}
        />
        {isPwd && (
