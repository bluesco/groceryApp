export const emailValidator = email => {
    ...
    return '';
  }; // check trước hết để đỡ call backend
  ...
  export const passwordValidator = password => {
    ...
    if (password.length <= 5) return 'Password must have at least 6 words';
  ...
  export const nameValidator = name => {
    ...
    if (name.length <= 5) return 'Name must have at least 6 words';
